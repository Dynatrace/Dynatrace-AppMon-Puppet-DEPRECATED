...
class dynatrace::role::php_one_agent (
  ...
  $ini_file_name        = $dynatrace::php_one_agent_php_config_file_name,
  $ini_file_path        = $dynatrace::php_one_agent_php_config_file_path,
  $installer_prefix_dir = $dynatrace::php_one_agent_installer_prefix_dir,
  $agent_name           = $dynatrace::php_one_agent_name,
  $agent_version        = $dynatrace::php_one_agent_version,
  $server_hostname      = $dynatrace::php_one_agent_server_hostname,
  $one_agent_port       = $dynatrace::php_one_agent_port,
  $one_agent_name       = $dynatrace::php_one_agent_name,
  $installer_file_name  = $dynatrace::php_one_agent_installer_file_name,
  $installer_file_url   = $dynatrace::php_one_agent_installer_file_url,
  $installer_bitsize    = $dynatrace::php_one_agent_installer_bitsize,
  $service_name         = $dynatrace::php_one_agent_apache_service_name,
) inherits dynatrace {
